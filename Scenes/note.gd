...
@export_multiline var flavor_text: String = "It's just an ordinary object."
@export_multiline var clue_text: String = "The ink is fresh, though you're not certain it's actually ink. 'He was always lost in other worlds, never truly there.'"
var is_player_in_range: bool = false

func _unhandled_input(event):
	if event.is_action_pressed("interact") and is_player_in_range:
		interact()
